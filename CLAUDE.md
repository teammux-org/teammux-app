...
- v0.1.4 — git worktree isolation, fully autonomous Team Lead, persistent sessions, PR lifecycle, worker-to-worker messaging, CLAUDE.md context viewer (16 streams, all merged)
